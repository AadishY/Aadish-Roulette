        ...
        <div className="absolute inset-0 z-50 flex items-center justify-center bg-black/95 overflow-y-auto pointer-events-auto">
            <div className="text-center max-w-lg w-full p-4 md:p-6 flex flex-col justify-center min-h-[350px]">
                ...
                <div className="flex flex-col gap-4 md:gap-6">
                    ...
                    <button onClick={onStartGame} disabled={!inputName.trim()} className="w-full px-6 py-4 bg-stone-100 text-black font-black text-lg md:text-xl hover:bg-red-600 hover:text-white transition-all disabled:opacity-50 tracking-widest">START GAME</button>
