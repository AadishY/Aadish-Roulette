...
export const IntroScreen: React.FC<IntroScreenProps> = ({ inputName, setInputName, onStartGame, onStartMultiplayer, onOpenSettings, onOpenGuide }) => {
    ...
    return (
        <div className="absolute inset-0 z-50 flex items-center justify-center overflow-hidden pointer-events-auto">
            ...
            <div className="relative z-10 text-center max-w-lg w-full p-1 md:p-4 flex flex-col justify-center scale-[0.35] sm:scale-[0.75] md:scale-100 origin-center">
                <h1 className="text-5xl sm:text-6xl md:text-8xl lg:text-9xl font-black mb-1 md:mb-12 text-stone-100 tracking-tighter text-glitch leading-none">AADISH<br /><span className="text-red-600">ROULETTE</span></h1>
