...
import { Users, RotateCcw, Power, ChevronDown, ChevronUp, Skull, Globe, Settings as SettingsIcon } from 'lucide-react';
              ...
              <div className="text-center max-w-lg w-full p-4 md:p-6 flex flex-col justify-center min-h-[350px]">
                ...
                <div className="flex flex-col gap-4 md:gap-6">
                    ...
                    <div className="flex gap-4">
                        <button disabled className="flex-1 px-6 py-4 bg-stone-900 border-2 border-stone-800 text-stone-500 font-black text-lg md:text-xl flex items-center justify-center gap-3 tracking-widest opacity-60 cursor-not-allowed">
