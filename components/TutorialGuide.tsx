...
export const TutorialGuide: React.FC<TutorialGuideProps> = ({ onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/95 backdrop-blur-md p-2 md:p-4">
            <div
                className="w-full max-w-2xl bg-gradient-to-b from-stone-900 to-stone-950 border border-stone-700/50 shadow-2xl shadow-black/50 relative flex flex-col max-h-[95vh] md:max-h-[90vh] rounded-sm overflow-hidden"
